  ...
  return (
    <div className='flex flex-col items-center'>
        ...
        <div className='flex flex-col items-center gap-3 py-10'>
            ...
            <div className='w-80 bg-gradient-to-r from-[#101010] via-[#AE7C53] to-[#101010] h-[2px]'></div>
            <h1 className={`${federo.className} text-6xl tracking-tight bg-gradient-to-r from-[#FFFFFF] to-[#AE7C53] inline-block text-transparent bg-clip-text`}>Our Mission</h1>
            <p className={`${dmsans.className} text-white tracking-tight w-1/2 text-center`}>Dedicated to redefining luxury, we craft timeless jewelry that embodies elegance, celebrates individuality, and creates cherished memories for generations to come.</p>
        </div>
        <div className='flex justify-between px-28 py-10'>
            {missions.map((mission) => {
                return(
                    <div className='flex flex-col items-center gap-5' key={mission}>
