...
const needs = [
  {
      svg: (
          <svg data-slot="icon" fill="none" strokeWidth="1" stroke="black" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  },
  {
      ...
      subtitle: "Rigorous standards to ensure every piece meets perfection."
  },
  {
      svg: (
        <svg data-slot="icon" fill="none" stroke-width="1" stroke="black" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
},
{
  ...
  subtitle: "Offering exquisite jewellery pieces for impactful corporate gifts."
},
{
  svg: (
    <svg data-slot="icon" fill="none" stroke-width="1" stroke="black" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  subtitle: "Committed to responsibly sourcing materials with transparency and integrity."
},
{
  svg: (
    <svg data-slot="icon" fill="none" stroke-width="1" stroke="black" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
  ...
  subtitle: "Ensuring fair, safe, and respectful working conditions for all involved in the production process."
},
