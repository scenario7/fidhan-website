...
const needs = [
  {
      svg: (
          <svg data-slot="icon" fill="none" strokeWidth="0.8" stroke="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
{
  svg: (
    <svg fill="none" strokeWidth="0.8" stroke="white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" data-slot="icon">
