...
const StepCard = ({props}) => {
  return (
    <div className='flex items-start text-left gap-3'>
        <h2 className={`${dmsans.className} font-black text-6xl md:text-8xl bg-gradient-to-tr from-[#fbd1a3] to-[#C5B692] inline-block text-transparent bg-clip-text`}>{props.number}</h2>
